...
export default function Chain() {
  ...
  const materials = [
    { 
      ...
      description: 'Chaînes en or 18 carats',
      path: '/Chain/gold'
    },
    { 
      id: 'silver', 
      ...
      description: 'Chaînes en argent sterling 925',
      path: '/Chain/silver'
    },
    { 
      id: 'platinum', 
      ...
      description: 'Chaînes en platine pur',
      path: '/Chain/platinum'
    },
    { 
      id: 'rose-gold', 
      ...
      description: 'Chaînes en or rose 18 carats',
      path: '/Chain/rose-gold'
    },
  ];
  ...
  useEffect(() => {
    const fetchProduits = async () => {
      try {
        ...
        // Filter products for Chain category
        const filtered = productsData.filter(
          (p) => p.category === 'Chain' || p.name.includes('Chain')
        );
        ...
        console.error("Error fetching Chain products:", err);
    ...
    <>
      <section className="relative w-full h-screen bg-black overflow-hidden">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: 'url(https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=1200&h=800&fit=crop&crop=center)',
        ...
        <div className="absolute inset-0 bg-black bg-opacity-40 flex flex-col items-center justify-center px-4">
          <div className="text-center text-white max-w-3xl">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Chain Collection</h1>
            <p className="text-xl md:text-2xl mb-8">
              Chaînes élégantes pour sublimer votre style avec raffinement
            </p>
          </div>
        </div>
      </section>
