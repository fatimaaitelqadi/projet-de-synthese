...
import bracelBangles from './bracelBangles.jpg'
import charm from './charm.jpg'
import chuff from './chuff.jpg'
import chain from './Chain.jpg'
import tennis from './tenins.jpg';
...
const Braceles = () => {
  ...
  const faqData = [
    ...
    {
      question: "Proposez-vous une garantie sur vos Braceles ?",
      answer: "Oui, tous nos Braceles sont garantis 2 ans contre les défauts de fabrication. Nous offrons également un service de polissage gratuit la première année et des réparations à prix préférentiel."
    },
    {
  ...
  const materials = [
    { 
      ...
      name: 'Bangles', 
      image: bracelBangles,
      description: 'Bracelets joncs élégants',
      path: '/braceles/Bangles'
    },
    { 
      id: 'Tennis', 
      name: 'Tennis', 
      image: tennis,
      description: 'Bracelets tennis raffinés',
      path: '/braceles/Tennis'
    },
    { 
      id: 'Charm', 
      name: 'Charm', 
      image: charm,
      description: 'Bracelets à breloques',
      path: '/braceles/Charm'
    },
    { 
      id: 'Cuff', 
      name: 'Cuff', 
      image: chuff,
      description: 'Manchettes sophistiquées',
      path: '/braceles/Cuff'
    },
    { 
      id: 'Chain', 
    ...
    <div className="Braceles-page">
      ...
      <section className="hero-video">
        <div className="Main">
          ...
          <div className="content">
            <h1>Collection d'Braceles Exclusifs</h1>
      ...
      <section className="special-offer">
        <div className="offer-content">
          <h2>Offre Limitée !</h2>
          <p className="discount-code">CODE : Braceles10</p>
          <p>10% de réduction sur tous les Braceles en or aujourd'hui seulement</p>
