...
import Heritage from './Heritage.jpg';
import Artisanal from './Artisanal.jpg';
...
import './Anneaux.css';
import './BijouxTraditionnels.css';

const BijouxTraditionnels = () => {
  ...
  const faqData = [
    ...
    {
      question: "Proposez-vous une garantie sur vos BijouxTraditionnels ?",
      answer: "Oui, tous nos BijouxTraditionnels sont garantis 2 ans contre les défauts de fabrication. Nous offrons également un service de polissage gratuit la première année et des réparations à prix préférentiel."
    },
    {
  ...
  const materials = [
    { 
      ...
      name: 'Ceremonial', 
      image: Ceremonial,
      description: 'Bijoux pour les cérémonies traditionnelles',

      path: '/bijoux-traditionnels/Ceremonial'
    },
    { 
      id: 'Wedding', 
      name: 'Wedding', 
      image: Wedding,
      description: 'Collection spéciale mariage',
      path: '/bijoux-traditionnels/Wedding'
    },
    { 
      id: 'Heritage', 
      name: 'Heritage', 
      image: Heritage,
      description: 'Bijoux inspirés de notre patrimoine',
      path: '/bijoux-traditionnels/Heritage'
    },
    { 
      id: 'Artisanal', 
      name: 'Artisanal', 
      ...
      path: '/bijoux-traditionnels/Artisanal'
    }
  ];
  ...
  return (
    <div className="anneaux-page bijoux-traditionnels-page">
      {/* Hero Section */}
      <section className="hero-video bijoux-hero">
        <div className="Main">
          <div 
            className="video bijoux-background"
            style={{ 
              backgroundImage: `url(${imageBijoux})`,
          ...
          ></div>
          <div className="content bijoux-content">
            <h1>Bijoux Traditionnels</h1>
            <p>L'élégance intemporelle de notre patrimoine culturel</p>
          </div>
        </div>
      </section>
      ...
      <section className="special-offer">
        <div className="offer-content">
          <h2>Offre Spéciale Tradition</h2>
          <p className="discount-code">CODE : TRADITION25</p>
          <p>25% de réduction sur notre collection de bijoux traditionnels</p>
...
export default BijouxTraditionnels;